...
#---- Routes commandes ----#
    ...
    Route::get('/commandes/commandesAValider', [CommandeController::class, 'commandeAValidee'])->name('commande.commandeAValidee');
    ...
    Route::get('/commandes/commandeImpayes', [CommandeController::class, 'commandeImpayes'])->name('commande.commandeImpayes');
