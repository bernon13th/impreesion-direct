...
class CommandeController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        /** @var Response $show */
        $commandes = json_decode(Http::withToken(session('key'))->get(env('API_PATH').'/commandes/'.$request->noCommande));
        //dd($request->noCommande);
        return view('commande.detailCommandes', ['commandes'=>$commandes]);
    }
    ...
    public function commandeAValidee()
    {
        /** GET commandes FROM API */
        /** @var Response $clientValider */
        $commandes = json_decode(Http::withToken(session('key'))->get(env('API_PATH') . '/commandes/'));
